	...
	public partial class CAUHOI : TableBase
	{
		...
		public override string UpdateFullStatement(string WhereClause)
		{
			...
			switch(this.DataManagement)
			{
				...
				case DBManagement.SQLLite:
				default:
				sbSQL.AppendFormat("[CH_GROUPID] = {0}", "@CH_GROUPID").AppendFormat(",[CH_DOITUONGHOI] = {0}", "@CH_DOITUONGHOI").AppendFormat(",[CH_DONVI_MST] = {0}", "@CH_DONVI_MST").AppendFormat(",[CH_DONVI_TEN] = {0}", "@CH_DONVI_TEN").AppendFormat(",[CH_DONVI_DIENTHOAI] = {0}", "@CH_DONVI_DIENTHOAI").AppendFormat(",[CH_NGUOIHOI_TAIKHOAN] = {0}", "@CH_NGUOIHOI_TAIKHOAN").AppendFormat(",[CH_NGUOIHOI_TEN] = {0}", "@CH_NGUOIHOI_TEN").AppendFormat(",[CH_NGUOIHOI_DIENTHOAI] = {0}", "@CH_NGUOIHOI_DIENTHOAI").AppendFormat(",[CH_NGUOIHOI_EMAIL] = {0}", "@CH_NGUOIHOI_EMAIL").AppendFormat(",[CH_NGUOIHOI_MAHQLIENQUAN] = {0}", "@CH_NGUOIHOI_MAHQLIENQUAN").AppendFormat(",[CH_CAUHOI_PHANLOAI] = {0}", "@CH_CAUHOI_PHANLOAI").AppendFormat(",[CH_CAUHOI_NOIDUNGCAUHOI] = {0}", "@CH_CAUHOI_NOIDUNGCAUHOI").AppendFormat(",[CH_CAUHOI_NGAYHOI] = {0}", "@CH_CAUHOI_NGAYHOI").AppendFormat(",[CH_CAUHOI_NOIDUNGTRALOI] = {0}", "@CH_CAUHOI_NOIDUNGTRALOI").AppendFormat(",[CH_CAUHOI_NGAYTRALOI] = {0}", "@CH_CAUHOI_NGAYTRALOI").AppendFormat(",[CH_NGUOITRALOI_TAIKHOAN] = {0}", "@CH_NGUOITRALOI_TAIKHOAN").AppendFormat(",[CH_NGUOITRALOI_TEN] = {0}", "@CH_NGUOITRALOI_TEN");
				break;
